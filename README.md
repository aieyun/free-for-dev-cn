...
## API、数据和机器学习
  ...
  * [Doczilla](https://www.doczilla.app/) — SaaS API 支持直接从 HTML/CSS/JS 代码生成截图或 PDF。免费计划每月允许 250 个文档。
  * [Doppio](https://doppio.sh/) — 管理 API 可使用顶级渲染技术生成和私下存储 PDF 和截图。免费计划每月允许 400 个 PDF 和截图。
  * [dreamfactory.com](https://dreamfactory.com/) — 开源的 REST API 后端，适用于移动、网络和物联网应用。连接任何 SQL/NoSQL 数据库、文件存储系统或外部服务，它会立即创建一个具有实时文档和用户管理的综合 REST API 平台。
  ...
  * [Hex](https://hex.tech/) - 一个用于笔记本、数据应用和知识库的协作数据平台。免费社区版最多支持 3 位作者和五个项目。每位作者一个计算配置文件，具有 4GB RAM。
  ...
  * [ipbase.com](https://ipbase.com) - IP 地理位置 API - 永久免费计划，每月涵盖 150 次请求。
  * [IP Geolocation](https://ipgeolocation.io/) — IP 地理位置 API - 开发者的永久免费计划，每月有 30k 请求（1k/天）限制。
  ...
  * [IP2Location.io](https://www.ip2location.io/) — 免费增值、快速可靠的 IP 地理位置 API，可确定城市、坐标、ISP 等地理位置数据。免费计划每月提供 30k 积分。订阅付费计划以获取更多高级功能或联系我们获取个性化计划。
  * [ipapi](https://ipapi.co/) - IP 地址位置 API by Kloudend, Inc - 基于 AWS 构建的可靠地理位置 API，受到财富 500 强企业的信赖。免费层每月提供 30k 次查找（1k/天），无需注册。
  * [ipapi.is](https://ipapi.is/) - 来自开发者的可靠 IP 地址 API，具有现有的最佳主机检测功能。免费计划提供 1000 次查找，无需注册。
  ...
  * [IPTrace](https://iptrace.io) — 一个简单得令人尴尬的 API，为您的企业提供可靠且有用的 IP 地理位置数据。
  * [JSON2Video](https://json2video.com) - 一个视频编辑 API，可自动进行视频营销和社交媒体视频的制作，通过编程或无代码实现。
  * [JSON IP](https://getjsonip.com) — 返回请求的客户端的公共 IP 地址。免费层无需注册。使用 CORS，可以直接从浏览器使用客户端 JS 请求数据。对于监控客户端和服务器 IP 变化的服务很有用。无限制请求。
  * [JSON Serve](https://jsonserve.com/) — 一项免费服务，帮助开发人员存储 JSON 对象并在其应用中使用该 JSON 作为 REST API。
  * [JSONing](https://jsoning.com/api/) — 从 JSON 对象创建假的 REST API，并自定义 HTTP 状态码、标头和响应体。
  * [konghq.com](https://konghq.com/) — API 市场和强大的私有和公共 API 工具。在免费层中，一些功能如监控、警报和支持受到限制。
  * [Kreya](https://kreya.app) — 免费的 gRPC GUI 客户端，可调用和测试 gRPC API。可以通过服务器反射导入 gRPC API。
  * [Lightly](https://www.lightly.ai/) — 通过使用正确的数据来改进您的机器学习模型。免费使用多达 1000 个样本的数据集。
  * [LoginLlama](https://loginllama.app) - 一个登录安全 API，可检测欺诈和可疑登录并通知您的客户。每月免费 1,000 次登录。

  * [Market Data API](https://www.marketdata.app) - 提供股票、期权、共同基金等的实时和历史金融数据。免费的“永远免费”API 层级允许每天免费进行 100 次 API 请求。
...
## 团队和协作工具
  ...
  * [Notion](https://www.notion.so/) - Notion 是一款支持 Markdown 的笔记和协作应用程序，集成了任务、维基和数据库。该公司将该应用程序描述为一个用于笔记、项目管理和任务管理的一体化工作区。除了跨平台应用程序外，还可以通过大多数网络浏览器访问。
  * [Nuclino](https://www.nuclino.com) - 一个轻量级的协作维基，用于团队的所有知识、文档和笔记。免费计划具有所有基本功能，最多 50 个项目和 5GB 存储空间。
  ...
  * [Teamhood](https://teamhood.com/) - 免费的项目、任务和问题跟踪软件。支持带有泳道的看板和完整的 Scrum 实施。具有集成的时间跟踪功能。五个用户和三个项目组合免费。
  ...
  * [twist.com](https://twist.com) — 一个异步友好的团队通信应用程序，对话保持组织和主题。提供免费和无限制计划。符合条件的团队可享受折扣。
  * [tldraw.com](https://tldraw.com) — 免费的开源白板和绘图工具，具有智能箭头、捕捉、便签和 SVG 导出功能。支持协作编辑的多人模式。还提供免费的官方 VS Code 扩展。
  * [BookmarkOS.com](https://bookmarkos.com) - 免费的一站式书签管理器、标签管理器和任务管理器，可在可定制的在线桌面上进行文件夹协作。
  ...
  * [windmill.dev](https://windmill.dev/) - Windmill 是一个开源开发者平台，可快速构建生产级多步骤自动化和内部应用程序，只需使用最少的 Python 和 Typescript 脚本。作为免费用户，您最多可以创建和成为三个非高级工作区的成员。
  * [vadoo.tv](https://vadoo.tv/) — 视频托管和营销变得简单。一键上传视频。记录、管理、分享等等。免费套餐提供多达 10 个视频、1GB 存储空间和 10GB/月的带宽
  ...
  * [Wormhole](https://wormhole.app/) - 端到端加密共享最多 5GB 的文件，最长 24 小时。对于大于 5GB 的文件，它使用点对点传输直接发送您的文件。
  ...
  * [robocorp.com](https://robocorp.com) - 为自动化操作提供动力的开源堆栈。免费试用云功能并实现简单的自动化。机器人工作 240 分钟/月，10 次助手运行，100MB 存储空间。
  * [Fleep.io](https://fleep.io/) — Fleep 是 Slack 的替代品。它为小型团队提供免费计划，包括完整的消息历史记录、无限的 1:1 对话、1 个群组对话和 1GB 文件存储。
  * [Chanty.com](https://chanty.com/) — Chanty 是 Slack 的另一种替代品。它为小团队（最多 10 人）提供免费的永久计划，包括无限的公共和私人对话、可搜索的历史记录、无限的 1:1 音频通话、无限的语音消息、十个集成和每个团队 20GB 存储空间。
  ...
  * [Revolt.chat](https://revolt.chat/) — [Discord](https://discord.com/)的开源替代品，尊重您的隐私。它还免费提供大多数来自 discord 的专有功能。Revolt 是一个安全快速的一体化应用程序，同时 100%免费。每个功能都是免费的。与大多数主流聊天应用程序不同，它们还支持（官方和非官方）插件。
...
## 测试
  ...
  * [Keploy](https://keploy.io/) - Keploy 是一个供开发人员使用的功能测试工具包。记录 API 调用会为 API (KTests) 和模拟或存根 (KMocks) 生成端到端测试。它对开源项目免费。
  ...
  * [lost-pixel.com](https://lost-pixel.com) - 针对您的 Storybook、Ladle、Histoire 故事和 Web 应用程序的整体视觉回归测试。无限制团队成员，完全开源免费，每月 7,000 个快照。
  ...
  * [snippets.uilicious.com](https://snippets.uilicious.com) - 它就像 CodePen 但用于跨浏览器测试。UI-licious 允许您像用户故事一样编写测试，并提供一个免费平台 - UI-licious Snippets - 允许您在 Chrome 上运行无限次测试，每次测试运行最多 3 分钟，无需注册。发现错误？您可以复制测试的唯一 URL 以向您的开发人员准确展示如何重现该错误。
  ...
  * [qase.io](https://qase.io) - 适用于开发和 QA 团队的测试管理系统。管理测试用例、编写测试运行、执行测试、跟踪缺陷并衡量影响。免费层级包括所有核心功能，附件可用空间为 500MB，最多可容纳 3 个用户。

  * [UseWebhook.com](https://usewebhook.com) - 从你的浏览器捕获和检查 Webhooks。转发到本地主机，或从历史记录中重放。免费使用。
  ...
  * [Vaadin](https://vaadin.com) - 使用 Java 或 TypeScript 构建可扩展的 UI，并使用集成的工具、组件和设计系统来更快地迭代、更好地设计并简化开发过程。无限制项目，五年免费维护。
  * [webhook-test.com](https://webhook-test.com) - 在集成期间使用唯一 URL 调试和检查 Webhooks 和 HTTP 请求。完全免费，你可以创建无限制的 URL 并接收推荐。

**[⬆️ 返回顶部](#table-of-contents)**

## 安全和PKI

  * [aikido.dev](https://www.aikido.dev) — 涵盖 SCA、SAST、CSPM、DAST、Secrets、IaC、恶意软件、容器扫描、EOL 等的一体化应用安全平台……免费计划包括两名用户、10 个存储库的扫描、1 个云、2 个容器和 1 个域名。
  ...
  * [Bridgecrew](https://bridgecrew.io/) — 由开源工具[Checkov](https://github.com/bridgecrewio/checkov)提供支持的基础设施即代码（IaC）安全。Bridgecrew 平台的核心部分对多达 50 个 IaC 资源免费。
  ...
  * [CyberChef](https://gchq.github.io/CyberChef/) — 一个简单直观的网络应用程序，用于分析和解码/编码数据，无需处理复杂的工具或编程语言。就像密码学和加密的瑞士军刀。所有功能均可免费使用，没有限制。如果您希望自托管，则开源。
  ...
  * [Doppler](https://doppler.com/) — 适用于应用程序秘密和配置的通用秘密管理器，支持同步到各种云提供商。最多可免费供五名用户使用基本访问控制。
  * [Dotenv](https://dotenv.org/) — 快速安全地同步您的.env 文件。停止通过不安全的渠道（如 Slack 和电子邮件）共享您的.env 文件，再也不会丢失重要的.env 文件。最多可免费供三名队友使用。
  * [GitGuardian](https://www.gitguardian.com) — 通过自动检测和修复秘密，防止秘密进入您的源代码。扫描您的 git 存储库中 350 多种类型的秘密和敏感文件 - 个人和最多 25 名开发人员的团队免费。
  ...
  * [Infisical](https://infisical.com/) — 开源平台，可让您跨团队和基础设施管理开发人员秘密：从本地开发到暂存/生产第三方服务的所有地方。最多可免费供五名开发人员使用。
  ...
  * [seclookup.com](https://www.seclookup.com/) - Seclookup API 可以在 SIEM 中丰富域威胁指标，提供有关域名的全面信息，并改进威胁检测和响应。在此处获取 50K 次免费查找[https://account.seclookup.com/](https://account.seclookup.com/)。
  ...
  * [StackHawk](https://www.stackhawk.com/) 在整个管道中自动化应用程序扫描，在它们进入生产环境之前查找并修复安全漏洞。单个应用程序的扫描和环境无限制。
  ...
  * [Ubiq Security](https://ubiqsecurity.com/) — 用三行代码加密和解密数据，并进行自动密钥管理。一个应用程序免费，每月最多可进行 1,000,000 次加密。
...
## 身份验证、授权和用户管理
  ...
  * [Corbado](https://www.corbado.com/) - 为新或现有应用程序添加密码优先认证。免费提供无限 MAU。
  * [Descope](https://www.descope.com/) - 高度可定制的 AuthN 流程，具有无代码和 API/SDK 方法，免费提供 7,500 个活跃用户/月，50 个租户（最多 5 个 SAML/SSO 租户）。
  * [duo.com](https://duo.com/) - 网站或应用程序的双因素认证（2FA）。免费提供给十个用户，所有身份验证方法，无限，集成，硬件令牌。
  ...
  * [WorkOS](https://workos.com/) - 免费用户管理和身份验证，多达 100 万 MAU。支持电子邮件+密码、社交身份验证、Magic Auth、MFA 等。
...
## 移动应用分发和反馈
  ...
  * [InstallOnAir](https://www.installonair.com) - 通过空中分发 iOS 和 Android 应用程序。免费计划：无限上传、私有链接、客人 2 天有效期、注册用户 60 天有效期。
...
## 管理系统
  ...
  * [Miradore](https://miradore.com) — 设备管理服务。随时了解您的设备舰队并免费保护无限数量的设备。免费计划提供基本功能。
...
## 消息传递和流媒体
  ...
  * [cloudamqp.com](https://www.cloudamqp.com/) — 作为服务的 RabbitMQ。小狐猴计划：每月最多 100 万条消息，最多 20 个并发连接，最多 100 个队列，最多 10,000 条排队消息，多个节点分布在不同的可用区。
  ...
  * [synadia.com](https://synadia.com/ngs) — 作为服务的[NATS.io](https://nats.io)。全球、AWS、GCP 和 Azure。永远免费，消息大小为 4k，活动连接数为 50，每月数据量为 5GB。
  ...
  * [eyeson API](https://developers.eyeson.team/) - 基于 WebRTC（SFU、MCU）的视频通信 API 服务，用于构建视频平台。允许实时数据注入、视频布局、录制、功能齐全的托管 Web UI（快速入门）或用于自定义 UI 的包。为开发人员提供[免费层](https://apiservice.eyeson.com/api-pricing)，每月有 1000 分钟的会议时间。
...
## 翻译管理
  ...
  * [localazy.com](https://localazy.com) - 1000 个源语言字符串免费，语言、贡献者和项目无限制，有创业和开源优惠
  * [Localeum](https://localeum.com) - 最多 1000 个字符串免费，一个用户，语言和项目无限制
  * [localizely.com](https://localizely.com/) — 开源项目免费
  * [Loco](https://localise.biz/) — 最多 2000 次翻译免费，翻译者无限制，每个项目十种语言，每个项目 1000 个可翻译资产
  * [oneskyapp.com](https://www.oneskyapp.com/) — 最多 5 个用户的有限免费版，开源项目免费
  * [POEditor](https://poeditor.com/) — 最多 1000 个字符串免费
  * [SimpleLocalize](https://simplelocalize.io/) - 最多 100 个翻译键免费，字符串、语言和项目无限制，有创业优惠
  ...
  * [weblate.org](https://weblate.org/) — 对于自由项目，最多 10,000 个字符串源的免费层级是免费的，并且在本地无限自托管。
...
## 监控
  ...
  * [alerty.ai](https://www.alerty.ai) - 为前端、后端、数据库等提供免费的 APM 和监控，以及免费的代理运行。
  ...
  * [checklyhq.com](https://checklyhq.com) - 为开发人员提供开源的 E2E/合成监控和深度 API 监控。免费计划包括五个用户和 50k+检查运行。
  ...
  * [cronitor.io](https://cronitor.io/) - 为 cron 作业、网站、API 等提供性能洞察和正常运行时间监控。提供一个带有五个监视器的免费层级。
  * [datadoghq.com](https://www.datadoghq.com/) — 免费提供多达 5 个节点。
  * [deadmanssnitch.com](https://deadmanssnitch.com/) — 用于监控 cron 作业。一个免费的告密者（监视器），如果您推荐其他人注册，则可以获得更多。
  * [downtimemonkey.com](https://downtimemonkey.com/) — 提供 60 个正常运行时间监视器，间隔为 5 分钟。提供电子邮件、Slack 警报。
  * [economize.cloud](https://economize.cloud) — Economize 通过组织云资源来优化和报告，帮助揭开云基础设施成本的神秘面纱。每月在 Google Cloud Platform 上花费高达 5,000 美元的费用免费。
  ...
  * [inspector.dev](https://www.inspector.dev) - 在不到一分钟的时间内提供一个完整的实时监控仪表板，具有免费的永久层级。
  ...
  * [letsmonitor.org](https://letsmonitor.org) - SSL 监控，最多可免费进行 5 次监控。
  * [linkok.com](https://linkok.com) - 在线损坏链接检查器，对于小型网站（最多 100 页）免费，对于开源项目完全免费。
  ...
  * [Middleware.io](https://middleware.io/) - 中间件可观察性平台提供对您的应用程序和堆栈的完全可见性，因此您可以大规模监控和诊断问题。他们为开发社区使用提供了一个免费的永久计划，允许对多达 100 万个日志事件进行日志监控，对多达 2 个主机进行基础设施监控和 APM。
  ...
  * [opsgenie.com](https://www.opsgenie.com/) — 强大的警报和值班管理，用于运营始终在线的服务。最多免费提供 5 个用户。
  * [paessler.com](https://www.paessler.com/) — 强大的基础设施和网络监控解决方案，包括警报、强大的可视化功能和基本报告。最多免费提供 100 个传感器。
  * [pagecrawl.io](https://pagecrawl.io/) - 监控网站更改，最多可免费进行 6 个每天检查的监视器。
  * [syagent.com](https://syagent.com/) — 非商业性免费服务器监控服务、警报和指标。
  * [pagerly.io](https://pagerly.io/) - 在 Slack 上管理值班（与 Pagerduty、OpsGenie 集成）。最多免费提供 1 个团队（一个团队指一个值班）。
  * [pagertree.com](https://pagertree.com/) - 用于警报和值班管理的简单界面。最多免费提供 5 个用户。
  * [pingbreak.com](https://pingbreak.com/) — 现代正常运行时间监控服务。检查无限的 URL，并通过 Discord、Slack 或电子邮件获取停机通知。
  * [pingpong.one](https://pingpong.one/) — 具有监控功能的高级状态页面平台。免费层级包括一个带有 SSL 子域的可公开自定义的状态页面。开源项目和非营利组织可免费获得专业计划。
  ...
  * [zenduty.com](https://www.zenduty.com/) — 为网络运营、站点可靠性工程和 DevOps 团队提供端到端的事件管理、警报、值班管理和响应编排平台。最多可供 5 名用户免费使用。
  * [instatus.com](https://instatus.com) - 10 秒内获得一个漂亮的状态页面。免费永远，无限制的订阅和无限制的团队。
  * [Squadcast.com](https://squadcast.com) - Squadcast 是一款端到端的事件管理软件，旨在帮助您推广 SRE 最佳实践。最多可供 10 名用户免费使用。
  ...
  * [Better Stack](https://betterstack.com/better-uptime) - 正常运行时间监控、事件管理、值班调度/警报和状态页面在一个产品中。免费计划包括 10 个监控器，检查频率为 3 分钟和状态页面。
  * [Pulsetic](https://pulsetic.com) - 10 个监控器，6 个月的历史正常运行时间/日志，无限制的状态页面和自定义域包括在内！无限时间和无限制的电子邮件警报免费。您不需要信用卡。
...
## 崩溃和异常处理
  ...
  * [elmah.io](https://elmah.io/) — 面向 Web 开发者的错误日志记录和正常运行时间监控。开源项目可免费订阅小型企业版。
  * [Embrace](https://embrace.io/) — 移动应用监控。小团队每年最多 100 万用户会话免费。
  * [exceptionless](https://exceptionless.com) — 实时错误、功能、日志报告等。每月 3k 事件/1 用户免费。开源且易于自行托管，可无限制使用。
  ...
  * [sentry.io](https://sentry.io/) — Sentry 实时跟踪应用异常，有一个小型免费计划。每月 5k 错误/1 用户免费，自行托管无限制使用
  * [Axiom](https://axiom.co/) — 存储多达 0.5 TB 的日志，保留 30 天。包括与 Vercel 等平台的集成以及带有电子邮件/Discord 通知器的高级数据查询。
...
## 搜索
  ...
  * [CommandBar](https://www.commandbar.com/) - 统一搜索栏即服务，基于网络的 UI 小部件/插件，允许用户在您的产品内搜索内容、导航、功能等，有助于提高可发现性。每月活跃用户不超过 1000 人免费，无限制命令。
...
## 教育和职业发展
  ...
  * [The Odin Project](https://www.theodinproject.com/) - 免费的开源平台，课程重点为 JavaScript 和 Ruby 的 Web 开发。
  ...
  * [Roadmap.sh](https://roadmap.sh) - 涵盖从区块链到用户体验设计等开发所有方面的免费学习路线图。
...
## 电子邮件
  ...
  * [AnonAddy](https://anonaddy.com) - 开源的匿名电子邮件转发，免费创建无限个电子邮件别名。
  ...
  * [DNSExit](https://dnsexit.com/) - 最多可在您的域名下免费拥有 2 个电子邮件地址，存储空间为 100MB。支持 IMAP、POP3、SMTP、SPF/DKIM。
  * [EmailLabs.io](https://emaillabs.io/en) - 每月免费发送多达 9000 封电子邮件，每天最多 300 封。
  * [EmailOctopus](https://emailoctopus.com) - 最多可免费拥有 2500 个订阅者和每月 10000 封电子邮件。
  ...
  * [Temp-Mail.org](https://temp-mail.org/en/) - 利用多种域名的临时/一次性邮件生成工具。每次刷新页面时，电子邮件地址都会刷新。它完全免费，不包括任何服务的定价。
  ...
  * [FakeMailGenerator.com](https://www.fakemailgenerator.com/) - 一个德国的临时/一次性邮件生成器。支持 10 个域名，同时让您可以自由创建无限的地址。（包括广告）但除此之外，该服务不包含任何定价，完全免费。
  * [forwardemail.net](https://forwardemail.net) - 免费为自定义域名提供电子邮件转发。使用您的域名创建和转发无限数量的电子邮件地址（**注意**：如果您使用.casa、.cf、.click、.email、.fit、.ga、.gdn、.gq、.lat、.loan、.london、.men、.ml、.pl、.rest、.ru、.tk、.top、.work TLD，则必须付费，因为垃圾邮件）。
  ...
  * [EForw](https://www.eforw.com) - 为一个域名提供免费的电子邮件转发。接收和发送来自您的域名的电子邮件。
  ...
  * [Maildroppa](https://maildroppa.com) - 最多可免费拥有 100 个订阅者和无限封电子邮件，以及自动化功能。
  ...
  * [Mailtrap.io](https://mailtrap.io/) - 用于开发的假 SMTP 服务器，免费计划包含一个收件箱，100 条消息，没有团队成员，每秒 2 封电子邮件，没有转发规则。
  ...
  * [Sender](https://www.sender.net) - 每月最多发送 15000 封电子邮件，最多 2500 个订阅者。
  * [SendGrid](https://sendgrid.com/) - 每天免费发送 100 封电子邮件和 2000 个联系人。
  * [Sendpulse](https://sendpulse.com) - 每月 500 个订阅者，每月免费发送 15000 封电子邮件。
  * [SimpleLogin](https://simplelogin.io/) - 开源的、可自行托管的电子邮件别名/转发解决方案。免费提供 5 个别名，无限带宽，无限回复/发送。对教育工作者（学生、研究人员等）免费。
  * [Substack](https://substack.com) - 无限免费的时事通讯服务。当您对其收费时开始付费。
  ...
  * [Zoho](https://www.zoho.com) — 最初是电子邮件提供商，但现在提供一系列服务，其中一些有免费计划。具有免费计划的服务列表：
     ...
     - [Docs](https://zoho.com/docs) — 免费供 5 个用户使用，上传限制为 1GB 和 5GB 存储空间。Zoho Office Suite（Writer、Sheets 和 Show）捆绑在一起。
     ...
     - [Subscriptions](https://zoho.com/subscriptions) — 免费供 20 个客户/订阅和 1 个用户使用，所有付款托管由 Zoho 完成。存储最后 40 个订阅指标
     - [Checkout](https://zoho.com/checkout) — 产品计费管理，具有 3 个页面和最多 50 次付款。
     - [Desk](https://zoho.com/desk) — 客户支持管理，具有三个代理，私人知识库和电子邮件票证。与[Assist](https://zoho.com/assist)集成，用于一个远程技术人员和 5 台无人值守计算机。
...
## 功能切换管理平台
  ...
  * [Flagsmith](https://flagsmith.com) - 有信心地发布功能；管理跨 Web、移动和服务器端应用程序的功能标志。使用我们的托管 API，部署到您自己的私有云，或在本地运行。
  * [GrowthBook](https://growthbook.io) - 具有内置贝叶斯统计分析引擎的开源功能标志和 A/B 测试提供商。最多 3 个用户免费，功能标志和实验不受限制。
  * [Hypertune](https://www.hypertune.com) - 类型安全的功能标志、A/B 测试、分析和应用程序配置，具有 Git 风格的版本控制和同步、内存中、本地标志评估。最多 5 名团队成员免费，功能标志和 A/B 测试不受限制。
  * [Molasses](https://www.molasses.app) - 强大的功能标志和 A/B 测试。最多 3 个环境免费，每个环境有 5 个功能标志。
  * [Toggled.dev](https://www.toggled.dev) - 企业级、可扩展的多区域功能切换管理平台。免费计划包括多达 10 个标志、两个环境、无限制的请求。SDK、分析仪表板、发布日历、Slack 通知和所有其他功能都包含在无尽的免费计划中。
  * [Statsig](https://www.statsig.com) - 一个强大的功能管理、A/B 测试、分析等平台。其慷慨的免费计划提供无限制的座位、标志、实验和动态配置，支持每月多达 100 万次事件。
...
## 字体
  ...
  * [Bunny](https://fonts.bunny.net) 以隐私为导向的谷歌字体
...
## 表单
  ...
  * [Feathery](https://feathery.io) - 强大、对开发者友好的表单构建器。可构建注册和登录、用户引导、支付流程、复杂的金融应用等。免费计划允许每月最多 250 次提交和五个活动表单。
  ...
  * [HeyForm.net](https://heyform.net/) - 拖放式在线表单构建器。免费层允许您创建无限表单并收集无限次提交。附带预建模板、反垃圾邮件和 100MB 文件存储。
  * [Tally.so](https://tally.so/) - 99%的功能都是免费的。免费层允许您拥有：无限表单、无限提交、电子邮件通知、表单逻辑、收款、文件上传、自定义感谢页面等。
  ...
  * [Qualtrics Survey](https://qualtrics.com/free-account) - 使用此一流工具创建专业表单和调查。50 多个专家设计的调查模板。免费帐户限制为 1 个活动调查、每个调查 100 个响应和 8 种响应类型。
  ...
  * [Survicate](https://survicate.com/) - 从所有来源获取反馈并使用一个工具发送后续调查。使用 AI 自动分析反馈并提取见解。免费电子邮件、网站、产品内或移动调查、AI 调查创建者和每月 25 个响应。
  ...
  * [Qualli](https://usequalli.com) - 应用内调查，专为移动设计。使用 Qualli AI 精心设计完美问题。您可以在我们的免费计划上试用，最多 500 个 MAU，创建无限表单和触发器。
...
## 生成式AI
  ...
  * [Findr](https://www.usefindr.com/) - 通用搜索，可一次性搜索所有应用。搜索助手，可使用您的信息回答问题。免费计划提供无限统一搜索和 5 个每日协同飞行员查询。
  ...
  * [Ultra AI](https://ultraai.app) - 产品的 AI 指挥中心。功能包括多提供商 AI 网关、提示管理器、缓存、日志、分析、模型回退和用户速率限制。免费永远计划每月提供 10k+次请求和除缓存外的所有功能。
  * [Comet Opik](https://www.comet.com/site/products/opik/) - 在开发和生产生命周期中评估、测试和交付 LLM 应用程序。
  * [Langfuse](https://langfuse.com/) - 开源 LLM 工程平台，帮助团队协作调试、分析和迭代他们的 LLM 应用程序。免费永远计划每月包括 50k 次观察和所有平台功能。[#开源](https://github.com/langfuse/langfuse)
...
## CDN和保护
  ...
  * [Stellate](https://stellate.co/) - Stellate 是一个为您的 GraphQL API 提供的快速、可靠的 CDN，并且对两项服务免费。
...
## PaaS
  ...
  * [codenameone.com](https://www.codenameone.com/) — 针对 Java/Kotlin 开发人员的开源、跨平台移动应用开发工具链。免费用于商业用途，项目数量不限。
  * [deco.cx](https://www.deco.cx/en/dev) - 具有从 TypeScript 代码自动生成的可视化 CMS 的边缘原生前端平台。内置 A/B 测试、内容细分和实时分析。非常适合内容丰富的企业电子商务网站。每月最多 5k 页面浏览量或开源/个人项目免费。
  ...
  * [flightcontrol.dev](https://flightcontrol.dev/) - 使用 Git 推送风格工作流在您自己的 AWS 账户上部署 Web 服务、数据库等。免费层适用于个人 GitHub 存储库中具有 1 个开发人员的用户。AWS 成本通过 AWS 计费，但您可以使用积分和 AWS 免费层。
  * [gigalixir.com](https://gigalixir.com/) - Gigalixir 提供一个永远不会休眠的免费实例和一个限制为 2 个连接、10,000 行且无备份的免费层 PostgreSQL 数据库，适用于 Elixir/Phoenix 应用程序。
  * [Glitch](https://glitch.com/) — 具有代码共享和实时协作功能的免费公共托管。免费计划有每月 1000 小时的限制。
  * [Lade](https://www.lade.io/) - Lade 是一个为开发人员构建的云平台。免费层包括五项服务，可以是应用程序或数据库。每项服务包括 128MB RAM 和 1GB 存储空间。
  ...
  * [Koyeb](https://www.koyeb.com) - Koyeb 是一个对开发人员友好的无服务器平台，可在全球范围内部署应用程序。通过基于 git 的部署、原生自动扩展、全球边缘网络以及内置的服务网格和发现，无缝运行 Docker 容器、Web 应用程序和 API。免费实例允许您在德国法兰克福或美国华盛顿特区部署 Web 服务。在法兰克福（德国）、华盛顿特区（美国）和新加坡提供免费的托管 Postgres 数据库。512MB 内存、2GB 存储空间和 0.1 CPU。无需信用卡即可开始使用。
  ...
  * [genezio](https://genezio.com/) - 一个无服务器函数提供商，免费提供 100 万个函数调用、100GB 带宽和每月 10 个 cron 作业，仅用于非商业或学术用途。
...
## BaaS
  ...
  * [BMC Developer Program](https://developers.bmc.com/site/global/bmc_helix_platform/program/overview/index.gsp) - BMC 开发者计划提供文档和资源，帮助你为企业构建和部署数字创新。访问全面的个人沙箱，包括平台、SDK 和可用于构建和定制应用的组件库。
  ...
  * [darklang.com](https://darklang.com/) - 托管语言与编辑器和基础设施相结合。在测试期间可访问，计划在测试后提供慷慨的免费层级。
  ...
  * [hasura.io](https://hasura.io/) - Hasura 扩展你现有的数据库，无论它托管在哪里，并提供一个可以安全访问的即时 GraphQL API，用于 Web、移动和数据集成工作负载。免费提供 1GB/月的数据传递。
  * [iron.io](https://www.iron.io/) - 异步任务处理（如 AWS Lambda），提供免费层级和 1 个月的免费试用
  ...
  * [paraio.com](https://paraio.com) - 具有灵活身份验证、全文搜索和缓存的后端服务 API。免费提供给一个应用，1GB 的应用数据。
  * [progress.com](https://www.progress.com/kinvey) - 移动后端，入门计划具有无限的请求/秒，具有 1GB 的数据存储。企业应用支持
  * [pubnub.com](https://www.pubnub.com/) - 免费推送通知，每月最多 100 万条消息和 100 个活动的每日设备
  * [pushbots.com](https://pushbots.com/) - 推送通知服务。每月最多免费推送 150 万次
  * [pushcrew.com](https://pushcrew.com/) - 推送通知服务。最多可向 2,000 个订阅者发送无限通知
  * [pusher.com](https://pusher.com/beams) - 为 2000 个每月活跃用户提供免费、无限的推送通知。适用于 iOS 和 Android 设备的单个 API。
  ...
  * [Salesforce Developer Program](https://developer.salesforce.com/signup) - 使用拖放工具快速构建应用。通过点击自定义你的数据模型。使用 Apex 代码进一步扩展。使用强大的 API 与任何内容集成。使用企业级安全性保护。通过点击或任何领先的 Web 框架自定义 UI。免费开发者计划可访问完整的 Lightning 平台。
  * [ServiceNow Developer Program](https://developer.servicenow.com/) - 快速构建、测试和部署使你的组织工作更出色的应用程序。免费实例和早期预览访问。
  * [simperium.com](https://simperium.com/) - 立即自动将数据移动到任何地方，多平台，无限发送和存储结构化数据，最多 2,500 个用户/月
  * [Singlebase.cloud](https://singlebase.cloud) - SinglebaseCloud 是一个由 AI 驱动的一体化后端平台，可加速应用开发。它提供了诸如 Vector DB、Relational Document DB、Auth、Search 和 Storage 等工具，旨在简化后端开发。免费/入门计划提供关系型文档数据库、Auth、Search、Storage。
  * [stackstorm.com](https://stackstorm.com/) - 应用、服务和工作流程的事件驱动自动化，免费，无流程、访问控制、LDAP
  ...
  * [LeanCloud](https://leancloud.app/) - 移动后端。1GB 数据存储、256MB 实例、每天 3K API 请求和每天 10K 推送是免费的。（API 与 Parse Platform 非常相似）
...
## 低代码平台
  ...
  * [ReTool](https://retool.com/) - 用于构建内部应用程序的低代码平台。Retool 高度可定制。如果您可以使用 JavaScript 和 API 编写它，您可以在 Retool 中实现它。免费层允许每月最多五个用户，无限制的应用程序和 API 连接。
  ...
  * [outsystems.com](https://www.outsystems.com/) - 企业网络开发 PaaS，用于内部部署或云，免费的“个人环境”提供允许无限代码和每个应用程序最多 1GB 数据库。
  * [UI Bakery](https://uibakery.io) - 一个低代码平台，可加快自定义 Web 应用程序的构建速度。支持使用拖放构建 UI，并通过 JavaScript、Python 和 SQL 进行高度定制。提供云解决方案和自托管解决方案。免费提供给最多 5 名用户。
  * [Mendix](https://www.mendix.com/) - 企业快速应用开发，无限制的可访问沙箱环境支持总用户数，每个应用程序 0.5GB 存储和 1GB RAM。此外，免费层还允许使用 Studio 和 Studio Pro IDE。
  * [lil'bots](https://www.lilbots.io/) - 在线编写和运行脚本，利用免费的内置 API，如 OpenAI、Anthropic、Firecrawl 等。非常适合构建 AI 代理/内部工具并与团队共享。免费层包括对 API、AI 编码助手和每月 10,000 次执行信用的完全访问权限。

**[⬆️ 返回顶部](#table-of-contents)**

## Web托管

  * [Alwaysdata](https://www.alwaysdata.com/) — 提供 100MB 免费网络托管，支持 MySQL、PostgreSQL、CouchDB、MongoDB、PHP、Python、Ruby、Node.js、Elixir、Java、Deno、自定义网络服务器，可通过 FTP、WebDAV 和 SSH 访问；包含邮箱、邮件列表和应用程序安装程序。
  * [Awardspace.com](https://www.awardspace.com) — 免费网络托管 + 免费短域名，支持 PHP、MySQL、应用程序安装程序、电子邮件发送且无广告。
  ...
  * [surge.sh](https://surge.sh/) — 前端开发人员的静态网络发布。支持自定义域名的无限站点。
  * [telegra.ph](https://telegra.ph/) 使用 Quill 轻松创建网页。
  * [tilda.cc](https://tilda.cc/) — 一个站点，50 页，50MB 存储空间，在 170 多个可用的预定义块中仅主要的，没有字体，没有收藏夹图标，没有自定义域名。
  * [Vercel](https://vercel.com/) — 构建、部署和托管具有免费 SSL、全球 CDN 和每次 `git push` 时唯一的预览 URL 的 Web 应用程序。非常适合 Next.js 和其他静态站点生成器。
  * [Versoly](https://versoly.com/) — 以 SaaS 为重点的网站构建器 - 无限网站，70 多个块，五个模板，自定义 CSS，收藏夹图标，SEO 和表单。没有自定义域名。
  * [Qoddi](https://qoddi.com) - 类似于 Heroku 的 PaaS 服务，具有以开发者为中心的方法和全包功能。免费层级用于静态资产、暂存和开发人员应用程序。
  * [FreeFlarum](https://freeflarum.com/) - 社区驱动的免费 Flarum 托管，最多可支持 250 个用户（捐赠可从页脚删除水印）。
...
## DNS
  ...
  * [1.1.1.1](https://developers.cloudflare.com/1.1.1.1/) - 由 Cloudflare 提供的免费公共 DNS 解析器，快速且安全（加密你的 DNS 查询）。可用于绕过互联网提供商的 DNS 封锁，防止 DNS 查询窥探，并[阻止成人和恶意软件内容](https://developers.cloudflare.com/1.1.1.1/1.1.1.1-for-families)。也可以[通过 API 使用](https://developers.cloudflare.com/1.1.1.1/encrypted-dns/dns-over-https/make-api-requests)。注意：只是一个 DNS 解析器，不是 DNS 托管商。
  ...
  * [duckdns.org](https://www.duckdns.org/) — 免费的 DDNS，免费层最多可支持 5 个域名。有各种设置的配置指南。
  * [Dynv6.com](https://dynv6.com/) — 带有[API 支持](https://dynv6.com/docs/apis)的免费 DDNS 服务，并管理大量 DNS 记录类型（如 CNAME、MX、SPF、SRV、TXT 等）。
  * [freedns.afraid.org](https://freedns.afraid.org/) — 免费 DNS 托管。此外，还根据众多公共用户[贡献的域名](https://freedns.afraid.org/domain/registry/)提供免费子域名。注册后从“子域名”菜单获取免费子域名。
...
## 托管数据服务
  ...
  * [codehooks.io](https://codehooks.io/) — 易于使用的 JavaScript 无服务器 API/后端和 NoSQL 数据库服务，具有函数、类似 Mongdb 的查询、键/值查找、作业系统、实时消息、工作队列、强大的 CLI 和基于 Web 的数据管理器。免费计划有 5GB 存储空间和每分钟 60/API 调用。包括 2 个开发者。无需信用卡。
  ...
  * [FaunaDB](https://fauna.com/) — 无服务器云数据库，具有原生 GraphQL、多模型访问和每天高达 100MB 的免费层
  ...
  * [Turso by ChiselStrike](https://chiselstrike.com/) - Turso 是边缘数据库中的 SQLite 开发体验。Turso 提供了一个永远免费的入门计划，总存储量为 9GB，最多 500 个数据库，最多 3 个位置，每月 10 亿行读取，以及带有 SQLite 的本地开发支持。
  ...
  * [Neo4j Aura](https://neo4j.com/cloud/aura/) — 具有 Cypher 查询语言和 REST API 的托管原生图 DBMS/分析平台。图大小有限制（50k 个节点，175k 个关系）。
  * [Neon](https://neon.tech/) — 托管 PostgreSQL，0.5GB 存储空间（总计），1 个项目，10 个分支，无限数据库，始终可用的主分支（5 分钟后自动挂起），非主分支计算每月 20 小时的活动时间（总计）。
  * [Dgraph Cloud](https://cloud.dgraph.io/pricing?type=free) — 具有 GraphQL API 的托管原生图 DBMS。每天限制为 1MB 数据传输。
  * [Tinybird](https://tinybird.co) - 一种无服务器管理的 ClickHouse，通过 HTTP 进行无连接数据摄取，并允许您将 SQL 查询发布为托管 HTTP API。免费层没有时间限制，每天 10GB 存储+1000 个 API 请求。
  * [TigerGraph Cloud](https://www.tigergraph.com/cloud/) — 具有类似 SQL 的图查询语言和 REST API 的托管原生图 DBMS/分析平台。一个免费实例，具有两个 vCPU、8GB 内存和 50GB 存储空间，在闲置 1 小时后进入睡眠状态。
  * [TerminusCMS](https://terminusdb.com/pricing) — TerminusDB 的托管免费服务，这是一个用 Prolog 和 Rust 编写的文档和图数据库。免费用于开发，付费服务用于企业部署和支持。
  ...
  * [xata.io](https://xata.io) - Xata 是一个无服务器数据库，具有内置的强大搜索和分析功能。一个 API，多个类型安全的客户端库，并针对您的开发工作流程进行了优化。免费永远层足以满足业余爱好者的需求，它带有三个 Xata 单元，请参考网站了解单元定义。
  ...
  * [Nile](https://www.thenile.dev/) — 用于 B2B 应用程序的 Postgres 平台。无限数据库，始终可用，无停机，1GB 存储空间（总计），5000 万查询令牌，自动扩展，无限向量嵌入
...
## 隧道、WebRTC、Web套接字服务器和其他路由器
  ...
  * [Hamachi](https://www.vpn.net/) — LogMeIn Hamachi 是一项托管 VPN 服务，允许您安全地将类似 LAN 的网络扩展到分布式团队，其免费计划允许最多 5 人的无限网络。
  ...
  * [segment.com](https://segment.com/) — 中心，用于将事件转换并路由到其他第三方服务。每月免费提供 100,000 个事件。
  ...
  * [webhookrelay.com](https://webhookrelay.com) — 管理、调试、扇出和代理所有的 Webhooks 到公共或内部（即 localhost）目的地。此外，通过获取公共 HTTP 端点（`https://yoursubdomain.webrelay.io <----> http://localhost:8080`），可以通过隧道将在私有网络中运行的服务器暴露出来。
  ...
  * [ZeroTier](https://www.zerotier.com) — FOSS 管理的虚拟以太网即服务。免费计划中包含 25 个客户端的无限端到端加密网络。适用于桌面/移动/NA 的客户端；用于配置自定义路由规则和批准私有网络上新客户端节点的 Web 界面。
...
## 问题跟踪和项目管理
  ...
  * [Backlog](https://backlog.com) — 一个平台满足团队发布优秀项目的所有需求。免费计划提供 1 个项目，支持 10 个用户和 100MB 存储空间。
  ...
  * [Chpokify](https://chpokify.com/) — 基于团队的规划扑克，可节省冲刺估计时间。最多支持 5 个用户免费使用，免费的 Jira 集成，无限视频通话，无限团队，无限会话。
  ...
  * [Codegiant](https://codegiant.io) — 项目管理与存储库托管和 CI/CD。免费计划提供无限存储库、项目和文档，支持 5 名团队成员。每月 500 分钟 CI/CD 时间。每月 30000 分钟无服务器代码运行时间 1GB 存储库存储空间。
  ...
  * [Crosswork](https://crosswork.app/) - 多功能项目管理平台。最多支持 3 个项目免费使用，无限用户，1GB 存储空间。
  ...
  * [Instabug](https://instabug.com) — 适用于移动应用程序的综合错误报告和应用内反馈 SDK。免费计划最多支持 1 个应用程序和 1 个成员。
  ...
  * [Kumu.io](https://kumu.io/)  — 具有动画、装饰、过滤器、聚类、电子表格导入等功能的关系图。免费层允许无限的公共项目。图形大小不受限制。为学生提供免费的私人项目。如果您不想将文件公开在线（上传、编辑、下载、丢弃），则可以使用沙盒模式。
  * [Linear](https://linear.app/) — 具有简化界面的问题跟踪器。免费支持无限成员，文件上传大小最多 10MB，250 个问题（不包括存档）
  * [leiga.com](https://www.leiga.com/) — Leiga 是一款使用 AI 自动管理项目的 SaaS 产品，帮助您的团队保持专注并释放巨大潜力，确保项目按计划进行。最多支持 10 个用户、20 个自定义字段、2GB 存储空间免费使用，AI 视频录制限制为 5 分钟/视频，自动化运行限制为 20 次/用户/月。
  ...
  * [Ora](https://ora.pm/) - 敏捷任务管理和团队协作。最多支持 3 个用户免费使用，文件限制为 10MB。
  * [pivotaltracker.com](https://www.pivotaltracker.com/) — 无限公共项目和两个私人项目免费，总共三个活跃用户（读写）和无限被动用户（只读）。
  * [plan.io](https://plan.io/) — 项目管理与存储库托管和更多选项。免费为两名用户提供 10 个客户和 500MB 存储空间
  * [Plane](https://plane.so/) - Plane 是一个简单、可扩展、开源的项目和产品管理工具。免费支持无限成员，文件上传大小最多 5MB，1000 个问题。
  ...
  * [ScrumFast](https://www.scrumfast.com) - 具有非常直观界面的 Scrum 板，最多支持 5 个用户免费使用。

  * [Shortcut](https://shortcut.com/) - 项目管理平台。最多可供 10 个用户免费使用。
  * [SpeedBoard](https://speedboard.app) - 用于敏捷和 Scrum 回顾的看板 - 免费。
  * [Tadum](https://tadum.app) - 为定期会议设计的会议议程和会议记录应用程序，最多可供 10 人团队免费使用
  * [taiga.io](https://taiga.io/) — 面向初创企业和敏捷开发人员的项目管理平台，开源免费
  * [Tara AI](https://tara.ai/) — 简单的冲刺管理服务。免费计划具有无限的任务、冲刺和工作区，没有用户限制。
  * [targetprocess.com](https://www.targetprocess.com/) — 从看板和 Scrum 到几乎任何运营流程的可视化项目管理。无限用户免费，最多 1,000 个数据实体 {[更多详细信息](https://www.targetprocess.com/pricing/)}
  * [taskade.com](https://www.taskade.com/) — 实时协作任务列表和团队大纲。免费计划具有一个工作区，其中包含无限的任务和项目；1GB 文件存储；1 周的项目历史记录；每个视频会议有五名参与者。
  ...
  * [YouTrack](https://www.jetbrains.com/youtrack/buy/#edition=incloud) — 适用于 FOSS 项目和私人项目的免费托管 YouTrack（InCloud）（三个用户免费）。包括时间跟踪和敏捷板
  ...
  * [Toggl](https://toggl.com/) — 提供两个免费的生产力工具。[Toggl Track](https://toggl.com/track/) 用于时间管理和跟踪应用程序，免费计划提供无缝时间跟踪和报告，专为自由职业者设计。它具有无限的跟踪记录、项目、客户、标签、报告等。而 [Toggl Plan](https://toggl.com/plan/) 用于任务规划，免费计划适用于具有无限任务、里程碑和时间线的独立开发人员。
  * [Sflow](https://sflow.io) — sflow.io 是为敏捷软件开发、营销、销售和客户支持构建的项目管理工具，特别适用于外包和跨组织协作项目。最多 3 个项目和 5 个成员的免费计划。
...
## 存储和媒体处理
  ...
  * [AndroidFileHost](https://androidfilehost.com/) - 具有无限速度、带宽、文件数量、下载次数等的免费文件共享平台。主要针对与 Android 开发相关的文件，如 APK 构建、自定义 ROM 和修改等。但似乎也接受任何其他文件。
  ...
  * [sync.com](https://www.sync.com/) - 端到端云存储服务。提供 5GB 的免费存储空间。
  ...
  * [cloudinary.com](https://cloudinary.com/) — 用于网站和应用程序的图像上传、强大的操作、存储和交付，支持 Ruby、Python、Java、PHP、Objective-C 等更多库。免费层包括每月 25 个信用额度。一个信用额度等于 1000 次图像转换、1GB 的存储空间或 1GB 的 CDN 使用量。
  * [embed.ly](https://embed.ly/) — 提供用于在网页中嵌入媒体、响应式图像缩放和从网页中提取元素的 API。每月免费提供多达 5000 个 URL，每秒 15 个请求。
  * [filestack.com](https://www.filestack.com/) — 文件选择器、转换和交付，免费提供 250 个文件、500 次转换和 3GB 带宽。
  * [file.io](https://www.file.io) - 2GB 的文件存储空间。文件在一次下载后会自动删除。提供与存储交互的 REST API。速率限制为每分钟一个请求。
  * [freetools.site](https://freetools.site/) — 免费的在线工具。转换或编辑文档、图像、音频、视频等。
  * [GoFile.io](https://gofile.io/) - 可通过基于 Web 的 UI 和 API 使用的免费文件共享和存储平台。无文件大小、带宽、下载次数等限制。但文件在不活动时（超过十天没有下载）将被删除。
  * [gumlet.com](https://www.gumlet.com/) — 通过 CDN 进行图像和视频托管、处理和流式传输。为视频提供慷慨的每月 250GB 的免费层，为图像提供每月 30GB 的免费层。
  * [image-charts.com](https://www.image-charts.com/) — 带有水印的无限图像图表生成。
  * [Imgbot](https://github.com/marketplace/imgbot) — Imgbot 是一个友好的机器人，可以优化您的图像并节省您的时间。优化后的图像意味着更小的文件大小而不牺牲质量。它对开源是免费的。
  ...
  * [Pinata IPFS](https://pinata.cloud) — Pinata 是在 IPFS 上上传和管理文件的最简单方法。我们友好的用户界面和 IPFS API 使 Pinata 成为平台、创作者和收藏家最简单的 IPFS 固定服务。提供 1GB 的免费存储空间，以及访问 API。
  * [placekitten.com](https://placekitten.com/) — 一个快速简单的服务，用于获取用作占位符的小猫图片。
  * [plot.ly](https://plot.ly/) — 绘制和分享您的数据。免费层包括无限的公共文件和十个私有文件。
  * [podio.com](https://podio.com/) — 您可以与最多五人的团队一起使用 Podio，并试用基本计划的功能，除了用户管理。
  * [QuickChart](https://quickchart.io) — 生成可嵌入的图像图表、图形和 QR 码。
  * [redbooth.com](https://redbooth.com) — P2P 文件同步，最多两个用户免费。
  ...
  * [transloadit.com](https://transloadit.com/) — 处理文件上传和视频、音频、图像、文档的编码。通过 GitHub 学生开发者包为开源、慈善机构和学生免费提供。商业应用程序可免费获得 2GB 的测试驱动。
  * [twicpics.com](https://www.twicpics.com) - 作为服务的响应式图像。它提供图像 CDN、媒体处理 API 和前端库，以自动化图像优化。该服务每月最多 3GB 流量免费。
  * [uploadcare.com](https://uploadcare.com/hub/developers/) — Uploadcare 提供基于最先进算法的终极工具包的媒体管道。所有功能对开发人员完全免费：文件上传 API 和 UI、图像 CDN 和原始服务、自适应交付和智能压缩。免费层有 3000 次上传、3GB 流量和 3GB 存储空间。
  * [imagekit.io](https://imagekit.io) — 具有自动优化、实时转换和存储的图像 CDN，您可以在几分钟内与现有设置集成。免费计划包括每月高达 20GB 的带宽。
  * [internxt.com](https://internxt.com) — Internxt Drive 是一种基于绝对隐私和不妥协安全性的零知识文件存储服务。注册并永远免费获得 10GB！
  * [degoo.com](https://degoo.com/) — 基于 AI 的云存储，免费提供高达 20GB、三个设备、5GB 推荐奖金（90 天账户不活动）。

  * [ImageEngine](https://imageengine.io/) - ImageEngine 是一个易于使用的全球图像 CDN。设置时间不到 60 秒。支持 AVIF 和 JPEGXL，提供 WordPress-、Magento-、React-、Vue-插件等。在此处[claim your free developer account](https://imageengine.io/developer-program/)领取您的免费开发者账号。
...
## 设计和UI
  ...
  * [Backlight](https://backlight.dev/) — 以开发人员和设计师之间的合作为核心，Backlight 是一个完整的编码平台，团队可以在其中构建、文档化、发布、扩展和维护设计系统。免费计划允许最多 3 个编辑器在一个设计系统上工作，并且有无限的查看者。
  ...
  * [cloudconvert.com](https://cloudconvert.com/) — 转换任何东西到任何东西。支持 208 种格式，包括视频和 gif。
  ...
  * [Branition](https://branition.com/colors) - 手工策划的颜色调色板，最适合品牌。
  * [css-gradient.com](https://www.css-gradient.com/) - 免费工具，可快速生成自定义的跨浏览器 CSS 渐变。支持 RGB 和 HEX 格式。
  * [easyvectors.com](https://easyvectors.com/) — EasyVectors.com 是一个免费的 SVG 矢量艺术库存。绝对免费下载最好的矢量图形。
  * [figma.com](https://www.figma.com) — 在线协作设计工具，用于团队；免费层级包括无限文件和查看者，最多 2 个编辑器和 3 个项目。
  * [Flyon UI](https://flyonui.com/)- Tailwind CSS 的最简单组件库。
  * [framer.com](https://www.framer.com/) - Framer 帮助您为下一个应用程序、网站或产品迭代和动画界面想法 - 从强大的布局开始。对于任何验证 Framer 作为专业原型工具的人：无限查看者，最多 2 个编辑器和最多 3 个项目。
  ...
  * [Icons8](https://icons8.com) — 图标、插图、照片、音乐和设计工具。免费计划提供有限的格式，分辨率较低。当您使用我们的资产时，请链接到 Icons8。
  * [landen.co](https://www.landen.co) — 为您的初创公司生成、编辑和发布美丽的网站和登录页面。所有这些都无需代码。免费层级允许您拥有一个网站，完全可定制并发布在网络上。
  ...
  * [LottieFiles](https://lottiefiles.com/) - 世界上最大的在线平台，为世界上最小的动画格式提供服务，适用于设计师、开发人员等。访问适用于 Android、iOS 和 Web 的 Lottie 动画工具和插件。
  * [MagicPattern](https://www.magicpattern.design/tools) — 一组用于渐变、图案和斑点的 CSS 和 SVG 背景生成器和工具。
  * [marvelapp.com](https://marvelapp.com/) — 设计、原型和协作，免费计划限于一个用户和一个项目。
  * [Mindmup.com](https://www.mindmup.com/) — 免费的无限思维导图，并将它们存储在云中。您的思维导图可以在任何地方、即时从任何设备访问。
  ...
  * [walkme.com](https://www.walkme.com/) — 企业级引导和参与平台，免费计划可进行三次最多 5 步的演练。
  ...
  * [iconify.design](https://icon-sets.iconify.design/) - 一个超过 100 个图标包的集合，具有统一的界面。允许您跨包搜索图标并将单个图标导出为 SVG 或用于流行的 Web 框架。
  ...
  * [Image BG Blurer](https://imagebgblurer.com/) - 使用图像源作为背景模糊为图像生成模糊背景框，适用于 Notion、Trello、Jira 和更多工具。
...
## 设计灵感
  ...
  * [Lapa Ninja](https://www.lapa.ninja/) - [着陆页/UI 套件/网页截图] Lapa Ninja 是一个画廊，展示了 6025 个最佳着陆页示例、免费的设计师书籍和来自网络的免费 UI 套件。
  * [LovelyLanding.net](https://www.lovelylanding.net/) - [着陆页设计] 频繁更新的着陆页截图。包括桌面、平板电脑和移动设备的截图。
  * [Mobbin](https://mobbin.design/) - [移动设备截图] 我们的图书馆拥有 50,000 多个完全可搜索的移动应用截图，可为您节省数小时的 UI 和 UX 研究时间。
  ...
  * [Screenlane](https://screenlane.com/) - [移动设备截图] 获取灵感并跟上最新的网页和移动应用 UI 设计趋势。可按模式和应用程序进行筛选。
  * [scrnshts](https://scrnshts.club/) - [移动设备截图] 精选的最佳应用商店设计截图集合。
  * [UI Garage](https://uigarage.net/) - [移动/网页截图] 设计师和开发人员的日常 UI 灵感和模式，为您的项目寻找灵感、工具和最佳资源。
  * [Refero](https://refero.design/) - [网页截图] 来自优秀网页应用程序的带标签和可搜索的设计参考集合。
...
## 地图上的数据可视化
  ...
  * [developers.arcgis.com](https://developers.arcgis.com) — 用于地图、地理空间数据存储、分析、地理编码、路由等的 API 和 SDK，适用于网络、桌面和移动设备。每月免费提供两百万个基础地图瓦片、20,000 个非存储地理编码、20,000 个简单路线、5,000 次驾驶时间计算和 5GB 免费瓦片+数据存储。
...
## IDE和代码编辑
  ...
  * [apiary.io](https://apiary.io/) — 协作设计 API，具有即时 API 模拟和生成文档（免费用于无限的 API 蓝图和无限的用户，带有一个管理员帐户和托管文档）。
  * [BBEdit](https://www.barebones.com/) - BBEdit 是一款流行的可扩展的 macOS 编辑器。免费模式提供了一个[强大的核心功能集](https://www.barebones.com/products/bbedit/comparison.html)和升级到高级功能的途径。
  ...
  * [fakejson.com](https://fakejson.com/) — FakeJSON 帮助你使用其 API 快速生成假数据。发出一个描述你想要什么以及你想要它的方式的 API 请求。API 以 JSON 格式返回所有内容。加快创意的上市过程并假装有直到你成功。
  * [GetVM](https://getvm.io) — 即时免费的 Linux 和 IDEs 浏览器侧边栏。免费层包括每天 5 个 VM。
  * [GitPod](https://www.gitpod.io) — GitHub 项目的即时、随时可用的代码开发环境。免费层包括每月 50 小时。
  * [ide.goorm.io](https://ide.goorm.io) goormIDE 是完整的云 IDE。多语言支持，通过功能齐全的基于 Web 的终端进行基于 Linux 的容器，端口转发，自定义 URL，实时协作和聊天，共享链接，Git/Subversion 支持。还有许多其他功能（免费层包括每个容器 1GB RAM 和 10GB 存储，5 个容器插槽）。
  ...
  * [jsbin.com](https://jsbin.com) — JS Bin 是另一个 Web 前端（HTML、CSS 和 JavaScript）的游乐场和代码共享网站。它还支持 Markdown、Jade 和 Sass。
  * [jsfiddle.net](https://jsfiddle.net/) — JS Fiddle 是一个支持协作的 Web 前端游乐场和代码共享网站。
  ...
  * [Paiza](https://paiza.cloud/en/) — 在浏览器中开发 Web 应用程序，无需设置任何内容。免费计划提供一个服务器，具有 24 个 24 小时的生命周期和每天 4 小时的运行时间，具有 2 个 CPU 内核、2GB RAM 和 1GB 存储。
  ...
  * [VSCodium](https://vscodium.com/) - 由社区驱动，无遥测/跟踪，是微软编辑器 VSCode 的自由授权二进制分发版本
  ...
  * [WebComponents.dev](https://webcomponents.dev/) - 浏览器内的 IDE，可使用 58 个可用模板单独编码 Web 组件，支持故事和测试。
...
## 分析、事件和统计
  ...
  * [Hightouch](https://hightouch.com/) - Hightouch 是一个反向 ETL 平台，可帮助您将客户数据从数据仓库同步到 CRM、营销和支持工具。免费层级提供一个目标来同步数据。
  * [Avo](https://avo.app/) - 简化分析发布工作流程。单一事实来源跟踪计划、类型安全的分析跟踪库、应用内调试器和数据可观测性，可在发布前捕获所有数据问题。免费提供给两名工作区成员和 1 小时的数据可观测性回溯。
  ...
  * [GoatCounter](https://www.goatcounter.com/) - GoatCounter 是一个开源的网络分析平台，可作为托管服务（非商业用途免费）或自托管应用提供。它旨在提供易于使用且有意义的隐私友好型网络分析，作为 Google Analytics 或 Matomo 的替代品。免费层级适用于非商业用途，包括无限站点、六个月的数据保留和 10 万次页面浏览量/月。
  ...
  * [getinsights.io](https://getinsights.io) - 隐私为重点，无 Cookie 分析，每月最多 3k 次事件免费。
  * [heap.io](https://heap.io) - 自动捕获 iOS 或网络应用中的每个用户操作。每月最多 10K 次会话免费。
  * [Hotjar](https://hotjar.com) - 网站分析和报告。免费计划允许每天 2000 次页面浏览量。每天 100 次快照（最大容量：300）。三个快照热图可存储 365 天。无限团队成员。还包括应用内和独立调查、带有屏幕截图的反馈小部件。免费层级允许创建 3 个调查和 3 个反馈小部件，并每月收集 20 个响应。
  ...
  * [usabilityhub.com](https://usabilityhub.com/) - 在真实人员上测试设计和模型，并跟踪访客。免费提供给一名用户，无限测试
  ...
  * [Beampipe.io](https://beampipe.io) - Beampipe 是简单、隐私为重点的网络分析。最多 5 个域名和每月 10k 次页面浏览量免费。
  ...
  * [TrackWith Dicloud](https://dicloud.net/trackwith-privacy-focused-analytics/) - 免费轻量级隐私为重点的 Google Analytics 替代品。无限页面浏览量、无限访客、无限页面热图和目标跟踪。最多 3 个域名和每个域名 600 次会话回放免费。
...
## 访客会话记录
  ...
  * [OpenReplay.com](https://www.openreplay.com) - 具有用于错误重现的开发工具的开源会话回放，用于实时支持的实时会话，以及产品分析套件。每月一千个会话，可访问所有功能并保留 7 天。
  ...
  * [UXtweak.com](https://www.uxtweak.com/) — 记录并观看访客如何使用您的网站或应用。小项目免费无限时间
...
## 支付和计费集成
  ...
  * [Glassfy](https://glassfy.io/) - 应用内订阅基础设施、实时订阅事件和现成的盈利工具，适用于 iOS、Android、Stripe 和 Paddle。每月收入高达 1 万美元免费。
  * [Adapty.io](https://adapty.io/) - 适用于移动应用内订阅集成到 iOS、Android、React Native、Flutter、Unity 或网络应用的一站式解决方案，具有开源 SDK。每月收入高达 1 万美元免费。
  * [CoinMarketCap](https://coinmarketcap.com/api/) - 提供加密货币市场数据，包括最新的加密和法定货币汇率。免费层级每月提供 10K 次调用信用。
  ...
  * [CurrencyApi](https://currencyapi.net/) - 为实物和加密货币提供实时货币汇率，以 JSON 和 XML 格式提供。免费层级每月提供 1,250 次 API 请求。
  ...
  * [Moesif API Monetization](https://www.moesif.com/) - 通过基于使用的计费从 API 中产生收入。连接到 Stripe、Chargebee 等。免费层级每月提供 30,000 次事件。
...
## 评论平台
  ...
  * [Remarkbox](https://www.remarkbox.com/) - 开源托管评论平台，“一个主持人在几个域上完全控制行为和外观”，您可以根据自己的能力付费。
...
## 截图API
  ...
  * [microlink.io](https://microlink.io/) – 将任何网站转换为数据，例如元标记规范化、美化链接预览、抓取功能或作为服务的截图。每天免费提供 250 个请求。
  ...
  * [PhantomJsCloud](https://PhantomJsCloud.com) — 浏览器自动化和页面渲染。免费层每天提供多达 500 页。自 2017 年以来的免费层。
  * [Webshrinker.com](https://webshrinker.com) — Web Shrinker 提供网站截图和域名智能 API 服务。每月免费 100 个请求。
  * [Httpic.com](https://httpic.com) — 将任何网站转换为 jpg、png 或 pdf。捕获整页截图，调整视口，并注入自定义代码。每月免费层为 150 张图像。
...
## Flutter相关和无需Mac构建IOS应用程序
  ...
  * [CodeMagic](https://codemagic.io/) - CodeMagic 是一个完全托管的移动应用程序 CI/CD。您可以使用基于 GUI 的 CI/CD 工具进行构建、测试和部署。免费层级提供每月 500 分钟的免费时间和一个具有 2.3 GHz 和 8GB RAM 的 Mac Mini 实例。
...
## 杂项
  ...
  * [Blynk](https://blynk.io) - 一个具有 API 的 SaaS，用于控制、构建和评估物联网设备。免费开发者计划，可连接 5 个设备，提供免费云服务和数据存储。也有移动应用程序可用。
  * [Bricks Note Calculator](https://free.getbricks.app/) - 一个带有强大内置多行计算器的笔记应用程序（PWA）。
  * [Carbon.now.sh](https://carbon.now.sh) - 创建并分享代码片段，以类似美学截图的图像格式。通常用于在 Twitter 或博客文章中美学地分享/炫耀代码片段。
  ...
  * [fullcontact.com](https://www.fullcontact.com/developer/pricing/) - 通过向您的应用程序添加社交配置文件，帮助您的用户更多地了解他们的联系人。每月免费提供 500 次 Person API 匹配。
  ...
  * [Pika Code Screenshots](https://pika.style/templates/code-image) - 使用扩展从代码片段和 VS Code 创建美丽、可定制的截图。
  ...
  * [readme.com](https://readme.com/) - 美丽的文档变得简单，免费用于开源。
...
## 其他免费资源
  ...
  * [get.localhost.direct](https://get.localhost.direct) - 更好的 `*.localhost.direct` 通配符公共 CA 签名 SSL 证书，用于带有子域支持的 localhost 开发。
  ...
  * [Microsoft 365 Developer Program](https://developer.microsoft.com/microsoft-365/dev-program) - 获得免费的沙盒、工具和其他构建 Microsoft 365 平台解决方案所需的资源。订阅是一个 90 天的 [Microsoft 365 E5 Subscription](https://www.microsoft.com/microsoft-365/enterprise/e5)（不包括 Windows），可续订。如果您积极参与开发（使用遥测数据和算法测量），它将续订。
  ...
  * [SmallDev.tools](https://smalldev.tools/) - 一个免费的开发人员工具，允许您编码/解码各种格式、压缩 HTML/CSS/JavaScript、美化、在 JSON/CSV 和多种其他格式中生成假/测试数据集等更多功能。具有令人愉悦的界面。
  * [UseCSV by Layercode](https://layercode.com/usecsv) - 在几分钟内将 CSV 和 Excel 导入添加到您的 Web 应用程序。为您的用户提供愉快且强大的数据导入体验。无需任何信用卡详细信息即可免费开始，并立即开始集成 UseCSV。您可以创建无限数量的导入器并上传最大 100Mb 的文件。
  ...
  * [SimpleRestore](https://simplerestore.io) - 无忧的 MySQL 备份恢复。无需代码或服务器即可将 MySQL 备份还原到任何远程数据库。
  * [360Converter](https://www.360converter.com/) - 免费的有用网站，可转换：视频到文本 && 音频到文本 && 语音到文本 && 实时音频到文本 && YouTube 视频到文本 && 添加视频字幕。也许它会在短视频转换或简短的 YouTube 教程中有所帮助：）
